...
<link rel="stylesheet" href="//templates/flathost/css/flexslider.css" />
<script src="/templates/flathost/js/jquery-1.9.0.min.js"></script>
<script src="/templates/flathost/js/jquery.flexslider.js"></script>
