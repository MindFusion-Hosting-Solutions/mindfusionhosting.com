  ...
  <div class="container"> 
    ...
    <div class="flexslider">
      <ul class="slides">
        ...
        <li>
          <div class="slide2">
            <p><img src="http://cweb.mindfusionhosting.com/templates/flathost/images/server1.png" alt="server" class="img-responsive center-block"></p>
            <h1>Dedicated and VIP Hosting</h1>
          </div>
        </li>
        <li>
          <div class="slide3">
            <p class="pull-left"><img src="http://cweb.mindfusionhosting.com/templates/flathost/images/server2.png" alt="server" class="img-responsive"></p>
...
<div class="container"> 
  ...
  <div class="row mainFeatures" id="features">
    <div class="col-sm-6 col-md-4">
      <div class="img-thumbnail"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/secure_img.png" width="85" height="88" alt="secure">
        <div class="caption">
    ...
    <div class="col-sm-6 col-md-4">
      <div class="img-thumbnail"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/fast_img.png" width="85" height="88" alt="secure">
        <div class="caption">
          <h4>Super Fast</h4>
    ...
    <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-0">
      <div class="img-thumbnail"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/support_img.png" width="85" height="88" alt="secure">
        <div class="caption">
  ...
  <div class="row">
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/setup_icon.png" alt="icon" class="img-responsive">
      <h4>Instant Setup</h4>
    ...
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/backup_icon.png" alt="icon" class="img-responsive">
  ...
  <div class="row">
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/git_icon.png" alt="icon" class="img-responsive">
    ...
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/script_icon.png" alt="icon" class="img-responsive">
  ...
  <div class="row">
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/cpanel_icon.png" alt="icon" class="img-responsive">
    ...
    <div class="col-sm-6 features"> <img src="http://cweb.mindfusionhosting.com/templates/flathost/images/php_icon.png" alt="icon" class="img-responsive">
