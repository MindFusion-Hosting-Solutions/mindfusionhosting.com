...
<div class="container"> 
  ...
  <div class="row FeatLayout">
    <div class="col-md-5 Featimg"> <img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcS0aOXCemJn3asNReRpUkULmMVtUeOQjxOREnLeY3AdME3wzXtYNQ" alt="feature" class="img-responsive center-block"></div>
    <div class="col-md-7">
      <h1>Hosting Features</h1>
      <p class="lead"></p>
      <p>As soon as you make a successful payment from our billing platform, your web hosting and domain names will be activated immediately. No waiting time whatsoever. Our network runs the latest stable and secure versions of PHP &amp; MySQL. </p>
      <ul class="ticklist">
        <li>Extremely Fast Servers</li>
        <li>cPanel&trade; Access</li>
  ...
  <div class="row PageHead">
    <div class="col-md-12">
      <h1>More Features</h1>
      <h3>You will get lot of features with MindFusion Hosting</h3>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 features"> <img src="images/script_icon.png" alt="icon" class="img-responsive">
      <h4>369+ Install Scripts</h4>
      <p>All our hosting accounts allow you to install popular software such as Wordpress, Drupal, Joolma and Magento in one easy step. Upgrading your software is just as easy! Our scripts installer is updated often with new tools and scripts. See the current list of <a href="softaculous.php">availble software</a></p>
    </div>
  </div>
  <div class="row">
