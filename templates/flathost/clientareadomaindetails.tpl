    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="internalpadding">
                ...
                <div class="col-sm-6">
                    <p><h4><strong>{$LANG.recurringamount}:</strong></h4> {$recurringamount} {$LANG.every} {$registrationperiod} {$LANG.orderyears}{if $renew} &nbsp; <a href="cart.php?gid=renewals" class="btn btn-xs btn-success">{$LANG.domainsrenewnow}</a>{/if}</p>
                </div>
                </div>
                <div class="row">
                <div class="col-sm-6">
...
<div data-toggle="tab" id="tab2" class="tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="internalpadding">
                <h4><strong>{$LANG.domainautorenewstatus}:</strong> <strong>{if $autorenew}<span class="text-success">{$LANG.domainsautorenewenabled}</span>{else}<span class="text-danger">{$LANG.domainsautorenewdisabled}</span>{/if}</strong></h4>
