<div class="halfwidthcontainer"> {include file="$template/pageheader.tpl" title=$LANG.login}
  ...
  <form method="post" action="{$systemsslurl}dologin.php" class="form-stacked">
    <div class="logincontainer">
      <fieldset class="control-group">
        ...
        <div align="center">
          <div class="loginbtn">
            <input type="submit" class="btn btn-primary btn-large" value="{$LANG.loginbutton}" />
          </div>
          <div class="rememberme">
            <input type="checkbox" name="rememberme"{if $rememberme} checked="checked"{/if} />
            <strong>{$LANG.loginrememberme}</strong></div>
          <br />
          <br />
