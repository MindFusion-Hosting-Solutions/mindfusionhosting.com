<form method="post" action="{$smarty.server.PHP_SELF}?action=bulkdomain" class="form-horizontal">
  ...
  <p>
    <label class="full control-label">
      <input type="radio" class="radio inline" name="nschoice" value="default" onclick="disableFields('domnsinputs',true)" checked />
      {$LANG.nschoicedefault}</label>
    <br />
    <label class="full control-label">
      <input type="radio" class="radio inline" name="nschoice" value="custom" onclick="disableFields('domnsinputs','')" checked />
...
function usecustomwhois(id) {
  ...
  <p>{$LANG.domainbulkmanagementchangesaffect}</p>
  <br />
  <blockquote> {foreach from=$domains item=domain}
    &raquo; {$domain}<br />
    {/foreach} </blockquote>
  ...
  <p>
    <label class="full control-label">
      <input type="radio" class="radio inline" name="wc[{$contactdetail}]" id="{$contactdetail}1" value="contact" onclick="usedefaultwhois(id)" />
  ...
  <p>
    <label class="full control-label">
      <input type="radio" class="radio inline" name="wc[{$contactdetail}]" id="{$contactdetail}2" value="custom" onclick="usecustomwhois(id)" checked />
  ...
  {/if}
  <p>
    <input type="button" value="{$LANG.clientareabacklink}" onclick="window.location='clientarea.php?action=domains'" class="btn" />
  </p>
  <br />
  <br />
</form>