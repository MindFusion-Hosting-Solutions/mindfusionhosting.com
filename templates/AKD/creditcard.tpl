...
{if $remotecode}
<div id="submitfrm" class="textcenter"> {$remotecode}
...
<form method="post" action="creditcard.php" class="form-horizontal">
  ...
  <fieldset class="control-group">
    <div class="control-group">
      <div class="col2half">
        <div class="internalpadding"> {include file="$template/subheader.tpl" title=$LANG.creditcardyourinfo}
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls"> {$countriesdropdown} </div>
          </div>
          <div class="control-group">
      ...
      <div class="col2half">
        <div class="internalpadding"> {include file="$template/subheader.tpl" title=$LANG.creditcarddetails}
          <p>
            <label class="full control-label">
              <input type="radio" class="radio inline" name="ccinfo" value="useexisting" onclick="disableFields('newccinfo',true)"{if $cardnum} checked{else} disabled{/if} />
              {$LANG.creditcarduseexisting}{if $cardnum} ({$cardnum}){/if}</label>
          </p>
          {if $cardnum} <br />
          <div class="control-group">
            <label class="control-label" for="cccvv2">{$LANG.creditcardcvvnumber}</label>
            <div class="controls">
              <input type="text" name="cccvv2" id="cccvv2" size="5" value="{$cccvv}" autocomplete="off" class="input-mini" />
              &nbsp;<a href="#" onclick="window.open('images/ccv.gif','','width=280,height=200,scrollbars=no,top=100,left=100');return false">{$LANG.creditcardcvvwhere}</a></div>
          </div>
          {/if}
          <p>
            <label class="full control-label">
              <input type="radio" class="radio inline" name="ccinfo" value="new" onclick="disableFields('newccinfo',false)"{if !$cardnum || $ccinfo eq "new"} checked{/if} />
              {$LANG.creditcardenternewcard}</label>
          </p>
          <br />
          <br />
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="ccnumber" id="ccnumber" size="30" value="{$ccnumber}" autocomplete="off" class="newccinfo" />
            </div>
          </div>
          {if $showccissuestart}
          <div class="control-group">
...
{/foreach}
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="ccissuenum" id="ccissuenum" size="5" maxlength="3" value="{$ccissuenum}" class="input-small newccinfo" />
            </div>
          </div>
          {/if}
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="cccvv" id="cccvv" size="5" value="{$cccvv}" autocomplete="off" class="input-mini newccinfo" />
              &nbsp;<a href="#" onclick="window.open('images/ccv.gif','','width=280,height=200,scrollbars=no,top=100,left=100');return false">{$LANG.creditcardcvvwhere}</a></div>
          </div>
          {if $shownostore}
          <p>
            <label class="full control-label">
              <input type="checkbox" name="nostore" id="nostore" class="newccinfo" />
              {$LANG.creditcardnostore}</label>
          </p>
          {/if} <br />
          <br />
          <p class="textcenter">
            <input class="btn btn-large btn-primary" type="submit" value="{$LANG.ordercontinuebutton}" onclick="this.value='{$LANG.pleasewait}'" />
          </p>
        </div>
      </div>
    </div>
