...
{if $pid}
<p class="textcenter"><a href="cart.php?a=add&pid={$pid}">{$LANG.ordernowbutton} &raquo;</a></p>
{/if}
{if $aid}
<p class="textcenter"><a href="cart.php?gid=addons">{$LANG.ordernowbutton} &raquo;</a></p>
{/if} <br />
<br />
<br />