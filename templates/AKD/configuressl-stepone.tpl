...
-----END CERTIFICATE REQUEST-----</textarea>
  ...
  <table width="100%" cellspacing="1" cellpadding="0" class="frame">
    <tr>
      <td><table width="100%" cellpadding="2">
          ...
          <tr>
            <td width="120" class="fieldarea">{$vals.name}</td>
            <td>{$vals.input} {$vals.description}</td>
          </tr>
          {/foreach}
        </table></td>
    </tr>
  ...
  <fieldset class="onecol">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" name="jobtitle" id="jobtitle" value="{$jobtitle}" />
        &nbsp; {$LANG.jobtitlereqforcompany} </div>
    </div>
    <div class="control-group">
