        ...
        <div class="control-group">
          ...
          <div class="controls">
            <label class="checkbox">
              ...
              {$LANG.subaccountactivatedesc} </label>
          </div>
        </div>
      </div>
      <div class="col2half">
