<div class="halfwidthcontainer"> {include file="$template/pageheader.tpl" title=$LANG.twofactorauth}
  ...
  <form method="post" action="{$systemsslurl}dologin.php" class="form-stacked" id="frmlogin">
    ...
    <br />
    <p align="center">
      <input type="submit" value="{$LANG.continue} &raquo;" class="btn" />
    </p>
    {elseif $backupcode} <br />
    <input type="hidden" name="backupcode" value="1" />
    <p align="center">
      <input type="text" name="code" size="25" />
      <input type="submit" value="Login &raquo;" class="btn" />
    </p>
    <p align="center"></p>
    {else} <br />
    {$challenge}
    ...
    {/if} <br />
    {if !$newbackupcode}
    <div class="alert alert-block alert-info textcenter"> {if $backupcode}
