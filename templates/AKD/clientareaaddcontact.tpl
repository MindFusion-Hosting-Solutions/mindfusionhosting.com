          ...
          <ul class="inputs-list">
            ...
            <li class="col2half">
              <label class="checkbox">
                ...
                {$LANG.subaccountpermsorders} </label>
            </li>
          </ul>
        </div>
      </div>
